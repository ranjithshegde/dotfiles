...
function settings.completion()
    ...
    G.completion_chain_complete_list = {
        ...
        default = {
            {complete_items = {'UltiSnips', 'lsp', 'snippet', 'snippets.nvim', 'path'}}, {mode = '<c-p>'},
            {mode = '<c-n>'}, {mode = 'thes'}
        }
    }
...
function settings.lsp_lintFormat()
    ...
    Lsp.diagnosticls.setup {
        ...
        init_options = {
            ...
            -- languagetool = {
            --     command = "java -jar /home/ranjith/Software/Curls/languagetool/languagetool.jar",
            --     debounce = 200,
            --     args = {"-"},
            --     offsetLine = 0,
            --     offsetColumn = 0,
            --     sourceName = "languagetool.jar",
            --     formatLines = 2,
            --     formatPattern = {
    ...
    local luaformat = {
        -- ${--tab-width:tabSize} ${--indent-width:tabSize}
