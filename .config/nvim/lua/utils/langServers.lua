...
-- Exclusive TexLabBuild
function langSettings.texlab_buf_build(bufnr)
...
-- Exclusive TexLabForward
function langSettings.texlab_buf_search(bufnr)
    local texlab_client = nil
    for _, v in ipairs(vim.lsp.buf_get_clients(0)) do
        if v.name == "texlab" then
            texlab_client = v
...
--                              Clangd                                --
------------------------------------------------------------------------
function langSettings.switchSourceHeader(bufnr)
    local clangClient = nil
    for _, v in ipairs(vim.lsp.buf_get_clients(0)) do
