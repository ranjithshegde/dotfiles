...
_G.packer_plugins = {
  ...
  ["commented.nvim"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/ranjith/.local/share/nvim/site/pack/packer/opt/commented.nvim"
  },
  ["completion-nvim"] = {
    loaded = true,
...
vim.cmd [[vnoremap <silent> gc <cmd>lua require("packer.load")({'commented.nvim'}, { keys = "gc", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> gc <cmd>lua require("packer.load")({'commented.nvim'}, { keys = "gc", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType supercollider ++once lua require("packer.load")({'scnvim', 'nvim-treesitter-refactor', 'ultisnips'}, { ft = "supercollider" }, _G.packer_plugins)]]
