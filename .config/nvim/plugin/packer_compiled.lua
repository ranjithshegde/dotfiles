...
_G.packer_plugins = {
  ...
  ["orgmode.nvim"] = {
    config = { "\27LJ\2\n‰\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\21org_agenda_files\23~/Documents/Orgs/*$org_highlight_latex_and_related\rentities\nsetup\forgmode\frequire\0" },
    loaded = false,
    needs_bufread = true,
...
vim.cmd [[au FileType supercollider ++once lua require("packer.load")({'scnvim', 'ultisnips', 'nvim-treesitter-refactor'}, { ft = "supercollider" }, _G.packer_plugins)]]
